 ...
 *
 * Real assets only (per-asset URLs — never profile hubs as cards):
 * - Gumroad: Night Drive
 ...
 *   feeds via catalog-asset-stores.js (studio catalog.json when populated)
...
(function () {
  ...
  var gumroadProducts = [
    withAuthor({
      ...
      rating: 0,
      ratingCount: 0,
      image: "asset-store/covers/night-drive.svg",
      stores: [
        {
          id: "gumroad",
  ...
  catalog.assets = gumroadProducts
  ...
  catalog.assets.forEach(function (p) {
    if (!p) return;
